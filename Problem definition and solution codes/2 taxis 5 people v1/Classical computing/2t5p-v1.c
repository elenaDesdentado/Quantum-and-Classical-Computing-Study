...
void get_taxi_assignment(int taxi_assignment[], int num_passengers){
    ...
    // Constraint check
    if (taxi_assignment[0] == taxi_assignment[1] && taxi_assignment[0] != taxi_assignment[2] && taxi_assignment[0] != taxi_assignment[3] && taxi_assignment[0] != taxi_assignment[4]){
